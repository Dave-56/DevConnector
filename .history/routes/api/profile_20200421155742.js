...
router.get('/github/:username', async (req, res) => {
  try {
      const options = {
          uri: `https://github.com/users/${req.params.username}/repos?per_page=5&sort=created:ascclient_id=${config.get('githubClientId)}&client_secret=${config.get('githubSecret')}`,
